                ...
                <div class="col-lg-8">
                    <div class="product__page__content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="https://navie-bucket-images-save-web.s3.ap-northeast-2.amazonaws.com/M_Aladdin.jpg">
                                    </div>
                                    <div class="product__item__text">
                                        <ul>
                                            <li>Adventure</li>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="https://navie-bucket-images-save-web.s3.ap-northeast-2.amazonaws.com/M_Extreme_Job.jpg">
                                    </div>
                                    <div class="product__item__text">
                                        <ul>
                                            <li>Comedy</li>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="https://navie-bucket-images-save-web.s3.ap-northeast-2.amazonaws.com/M_Ode_to_My_Father.jpg">
                                    </div>
                                    <div class="product__item__text">
                                        <ul>
                                            <li>Historical</li>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="https://navie-bucket-images-save-web.s3.ap-northeast-2.amazonaws.com/M_New_World.jpg">
                                    </div>
                                    <div class="product__item__text">
                                        <ul>
                                            <li>Action</li>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="https://navie-bucket-images-save-web.s3.ap-northeast-2.amazonaws.com/M_Along_with_the_Gods.jpg">
                                    </div>
                                    <div class="product__item__text">
                                        <ul>
                                            <li>Action</li>
                                        ...
                                        <h5><a href="#">신과 함께:죄와벌</a></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="https://navie-bucket-images-save-web.s3.ap-northeast-2.amazonaws.com/M_The_Admiral.jpg">
                                    </div>
                                    <div class="product__item__text">
                                        <ul>
                                            <li>Historical</li>
