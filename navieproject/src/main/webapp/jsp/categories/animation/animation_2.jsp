...
<body>
    ...
    <section class="anime-details spad">
        <div class="container">
        	<div class="episode_count section-title">겨울왕국2</div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="anime__details__episodes">
                        <button onclick="changeVideoSource('https://navie-bucket-video-save-web.s3.ap-northeast-2.amazonaws.com/A_Frozen_II_main_trailer.mp4', '겨울왕국2')">겨울왕국2</button>
                    </div>
                </div>
            </div>
