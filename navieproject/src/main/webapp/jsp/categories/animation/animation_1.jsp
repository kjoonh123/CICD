...
<body>
    ...
    <section class="anime-details spad">
        <div class="container">
        	<div class="episode_count section-title">너의이름은</div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="anime__details__episodes">
                        <button onclick="changeVideoSource('https://navie-bucket-video-save-web.s3.ap-northeast-2.amazonaws.com/A_your_name_fullver.mp4', '너의이름은')">너의이름은</button>
                    </div>
                </div>
            </div>
        </div>
