...
public class BoardService2 {
	...
	public void boardForm(String cp, Model model) {
		...
		List<BoardDTO2> boards = mapper.boardForm(begin, end);
		...
		// 목록 관련 설정
		String url = "boardForm2?currentPage=";
	...
	public BoardDTO2 boardContent(String no) {
		...
		BoardDTO2 board = mapper.boardContent(n);
	...
	public String boardModify(String no, Model model) {
		...
		return "board2/boardModify2";
	}

	public String boardModifyProc(BoardDTO2 board) {
		
		// DB의 board 테이블에서 해당 글번호의 데이터를 SELECT
		BoardDTO2 check = mapper.boardContent(board.getNo());
